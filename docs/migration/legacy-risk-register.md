...
| R-013 | Public Umami share access and per-page Traffic UI disclose more than intended | Medium | High | Security / 16、18 | Phase 16 review: no Share Token/cookie/third-party script; current stats only non-sensitive counts；future aggregate-only contract + Phase 18 continuity | CONTROLLED |
