...
| R-011 | Thousands of CDN references include Unicode and historic keys | Medium | High | Storage / 6、11、18 | Phase 6 validated local asset/Unicode render PASS；Phase 11 AList and Phase 18 audit pending | CONTROLLED |
